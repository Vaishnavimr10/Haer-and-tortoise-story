...
void display1() {
	...
	glClear(GL_COLOR_BUFFER_BIT);
	display_string(220,440,"ADICHUNCHANAGIRI INSTITUTE OF TECHNOLOGY",1);
	display_string(300,400,"COMPUTER GRAPHICS MINI PROJECT",1);
	display_string(310,350,"TOPIC : THE STORY OF HARE AND TORTOISE",2);
	display_string(40,200,"TEAM MEMBERS: SHREENIKA A K AND SHRESHTA K S",2);
	display_string(40,160,"PROJECT GUIDE : Ms. SATHYABHAMA MAM",2);
	...
	display_string(455,20,"ESCAPE TO EXIT",3);
	display_string(450,50,"F TO FULLSCREEN",3);
	display_string(418,80,"S TO MAKE THEM CONVERSE",3); // Press S to make them converse in the second screen.
	display_string(380,290,"PRESS SPACE BAR TO ENTER",2);
	//glutPostRedisplay();
	glutSwapBuffers();
	glFlush();
}
